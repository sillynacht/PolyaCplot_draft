...
#     z = sp.symbols('z')
#     f_expr = (z ** 2 + 1) / (z - 1)
#     polyaStreamplot(f_expr, z, density=20, streamline_density=2, x_range=(-2, 2), y_range=(-2, 2))
#     zeros(f_expr, z, x_range=(-2, 2), y_range=(-2, 2))
#     poles(f_expr, z, x_range=(-2, 2), y_range=(-2, 2))
#     plt.legend()
#     plt.show()
#
#
#     polyaVectorplot(f, density=20)
#     plt.show()
